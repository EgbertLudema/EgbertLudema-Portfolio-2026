            ...
            <ul className={styles.entryList}>
              {experience.map((item) => {
                ...
                return (
                  <li
                    key={item.id}
                    className={`${styles.entryItem} ${item.current ? styles.entryItemActive : ''} ${logo?.url ? styles.entryItemWithLogo : ''}`}
                  >
                    {logo?.url ? (
                      <img className={styles.entryLogo} src={logo.url} alt={logo.alt ?? ''} />
                    ) : null}
